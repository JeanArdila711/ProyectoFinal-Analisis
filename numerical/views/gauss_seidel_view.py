...
class GaussSeidelView(TemplateView):
    template_name = "numerical/cap2/gauss_seidel.html"
    ...
    def post(self, request: HttpRequest, *args: object, **kwargs: object) -> HttpResponse:
        ...
        try:
            ...
            print(f"✅ Validación: {response_validation}")

            if isinstance(response_validation, str):
                print(f"❌ Error de validación: {response_validation}")
                error_response = {
            ...
            print(f"✅ A, b, x0 extraídos correctamente")
            ...
            print(f"✅ Método resuelto: {method_response}")
