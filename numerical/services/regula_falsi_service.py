...
class RegulaFalsiService(IntervalMethod):
    def validate_input(
        ...
        # Protección por si los valores son exactamente iguales
        if abs(fb - fa) < 1e-12:
    ...
    def solve(
        ...
        # Protección adicional de entrada
        if abs(fb - fa) < 1e-12:
            return {
        ...
        while current_iteration <= max_iterations:
            ...
            # Valida de nuevo en cada iteración el denominador
            if abs(fb - fa) < 1e-14:
                return {
            ...
            # Actualización segura de extremos
            if fa * fxn < 0:
                interval[1] = Xn
                fb = fxn
            else:
